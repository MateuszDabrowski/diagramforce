...
const PRECACHE_URLS = [
  ...
  `./js/canvas/z-tiers.js?v=${CACHE_VERSION}`,
  `./js/canvas/icon-refresh.js?v=${CACHE_VERSION}`,
  `./js/canvas/link-styles.js?v=${CACHE_VERSION}`,
  ...
  `./js/canvas/diagram-check.js?v=${CACHE_VERSION}`,
  `./js/canvas/capture-overlay.js?v=${CACHE_VERSION}`,
  `./js/canvas/overlay-layer.js?v=${CACHE_VERSION}`,
  ...
  `./js/clone-cells.js?v=${CACHE_VERSION}`,
  // Pure Gantt geometry leaves — promoted out of js/canvas/ (S8): imported by shapes/components/
  // table-view/etc. with NO canvas-graph dependency, so they live in js/ as shared leaves.
  `./js/gantt-layout.js?v=${CACHE_VERSION}`,
  `./js/gantt-scale.js?v=${CACHE_VERSION}`,
  `./js/data-export.js?v=${CACHE_VERSION}`,
  `./js/er-markers.js?v=${CACHE_VERSION}`,
  `./js/feedback.js?v=${CACHE_VERSION}`,
  `./js/field-model.js?v=${CACHE_VERSION}`,
  ...
  `./js/persistence/host-env.js?v=${CACHE_VERSION}`,
  `./js/persistence/external-import.js?v=${CACHE_VERSION}`,
  ...
  `./js/properties/context.js?v=${CACHE_VERSION}`,
  `./js/properties/convert.js?v=${CACHE_VERSION}`,
  `./js/properties/field-editor.js?v=${CACHE_VERSION}`,
  ...
  `./js/properties/renderers-sequence.js?v=${CACHE_VERSION}`,
  `./js/properties/type-meta.js?v=${CACHE_VERSION}`,
  `./js/properties/widgets.js?v=${CACHE_VERSION}`,
  `./js/selection.js?v=${CACHE_VERSION}`,
  `./js/selection/resize-handles.js?v=${CACHE_VERSION}`,
  `./js/selection/context-menu.js?v=${CACHE_VERSION}`,
  `./js/shapes.js?v=${CACHE_VERSION}`,
  `./js/shapes/context.js?v=${CACHE_VERSION}`,
  `./js/shapes/fields.js?v=${CACHE_VERSION}`,
  `./js/shapes/markdown-fo.js?v=${CACHE_VERSION}`,
  `./js/shapes/ports.js?v=${CACHE_VERSION}`,
  `./js/shapes/task-sequence.js?v=${CACHE_VERSION}`,
  ...
  `./js/storage-ui.js?v=${CACHE_VERSION}`,
  ...
  `./js/tabs/context.js?v=${CACHE_VERSION}`,
  `./js/tabs/diagram-types.js?v=${CACHE_VERSION}`,
  ...
  `./js/toolbar/context.js?v=${CACHE_VERSION}`,
  `./js/toolbar/flow-animation.js?v=${CACHE_VERSION}`,
  `./js/toolbar/display-options.js?v=${CACHE_VERSION}`,
  `./js/toolbar/review.js?v=${CACHE_VERSION}`,
  `./js/toolbar/save-manager.js?v=${CACHE_VERSION}`,
  `./js/toolbar/load-manager.js?v=${CACHE_VERSION}`,
  `./js/toolbar/drive-history.js?v=${CACHE_VERSION}`,
  `./js/toolbar/sync-control.js?v=${CACHE_VERSION}`,
