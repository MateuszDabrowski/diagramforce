// ⚠️ VERBATIM COPY of the app's js/canvas/flow-layout.js, bundled so this skill is self-contained.
// Pure, zero-import and DOM-free by design, so it runs in plain Node here exactly as it does in the
// browser. Re-copy it from the repo whenever the app's layout changes. See SKILL.md "Staying in sync".
