...
- **No Backend, local-first** - Everything runs client-side; your diagrams stay in your browser unless you opt in to Google Drive sync. Every open diagram is auto-kept in this browser's session, and closing a tab archives a copy you can reopen (kept in this browser until you delete it)
