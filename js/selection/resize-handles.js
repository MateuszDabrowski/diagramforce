...
import { deriveGanttDates, ganttTimelineFor, snapGanttX, growTimelineToFitDates } from '../gantt-layout.js?v=1.21.3';
import { showGanttDateChip, clearGanttDateChip } from '../canvas.js?v=1.21.3';
