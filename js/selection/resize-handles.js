...
import { deriveGanttDates, ganttTimelineFor, snapGanttX, growTimelineToFitDates } from '../gantt-layout.js?v=1.19.3.8';
import { showGanttDateChip, clearGanttDateChip } from '../canvas.js?v=1.19.3.8';
