...
import { getVisibleDataObjectFields } from '../shapes.js?v=1.20.1';
import { nodeContrastText } from '../util.js?v=1.20.1';
import { getIconDataUri } from '../icons.js?v=1.20.1';
import { applyGanttGeometry, applyGanttMilestoneGeometry, deriveGanttMilestoneDate, applyGanttMarkerGeometry, deriveGanttMarkerDate, applyGanttGroupGeometry, backfillGanttDates, backfillGanttOrders, layoutTimelineTasks, migrateGanttTimeline } from '../gantt-layout.js?v=1.20.1';
