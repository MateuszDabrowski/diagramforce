...
import { getVisibleDataObjectFields } from '../shapes.js?v=1.19.3.8';
import { nodeContrastText } from '../util.js?v=1.19.3.8';
import { getIconDataUri } from '../icons.js?v=1.19.3.8';
import { applyGanttGeometry, applyGanttMilestoneGeometry, deriveGanttMilestoneDate, applyGanttMarkerGeometry, deriveGanttMarkerDate, applyGanttGroupGeometry, backfillGanttDates, backfillGanttOrders, layoutTimelineTasks, migrateGanttTimeline } from '../gantt-layout.js?v=1.19.3.8';
