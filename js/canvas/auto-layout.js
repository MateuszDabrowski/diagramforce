...
import { STUB as ROUTER_STUB, PAD as ROUTER_PAD } from './router.js?v=1.24.7';
// The layered engine, extracted pure (Stage C C2) so it can also drive scoped group interiors (C5).
import { layoutGraphSubset, detectFlowAxis, planLaneNormalisation } from './layout-core.js?v=1.24.7';
import { startBatch, endBatch } from '../history.js?v=1.24.7';
// Flow tree layout (S3) — pure, does NOT use the barycentre core (avoids the F7 join defect).
import { computeFlowLayout } from './flow-layout.js?v=1.24.7';
import { flowConnectorType } from './link-styles.js?v=1.24.7';
