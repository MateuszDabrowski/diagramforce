...
import { GANTT_HEADER_H, GANTT_BAR_DY, orderToY } from './gantt-layout.js?v=1.23.7';
...
import { node, SVG, GENERIC_SHAPES } from './components/stencil-kit.js?v=1.23.7';
import { FLOW_ELEMENTS } from './shapes/flow.js?v=1.23.7';
