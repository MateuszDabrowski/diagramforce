...
import { GANTT_HEADER_H, GANTT_BAR_DY, orderToY } from './gantt-layout.js?v=1.24.2';
import { localISODate } from './gantt-scale.js?v=1.24.2';
import { sanitizeCssColor } from './util.js?v=1.24.2';
...
import { node, SVG, GENERIC_SHAPES } from './components/stencil-kit.js?v=1.24.2';
import { FLOW_ELEMENTS } from './shapes/flow.js?v=1.24.2';
