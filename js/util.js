...
export function getDiagramTypeIcon(type) {
  const icons = {
    ...
    flow: '<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><rect x="5.5" y="0.5" width="5" height="3" rx="1"/><path d="M8 3.5 V5" stroke="currentColor" stroke-width="1.1" fill="none"/><path d="M8 5 L10.5 7.5 L8 10 L5.5 7.5 Z" fill="none" stroke="currentColor" stroke-width="1.2"/><path d="M5.5 7.5 H2.5 V12.5 M10.5 7.5 H13.5 V12.5" fill="none" stroke="currentColor" stroke-width="1" stroke-linejoin="round"/><rect x="0.5" y="12.5" width="4" height="3" rx="1" opacity="0.7"/><rect x="11.5" y="12.5" width="4" height="3" rx="1" opacity="0.7"/></svg>',
