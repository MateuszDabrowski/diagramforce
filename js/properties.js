...
import { wrapSelectionWithMarker } from './markdown.js?v=1.24.7';
import { ER_MARKER_D } from './er-markers.js?v=1.24.7';
import { cycleKeyType, keyImpliesRequired, keyTypeLabel, applyKeyType, newField } from './field-model.js?v=1.24.7';
import { COLOR_SCHEMA, recolorCellIcon } from './properties/color-schema.js?v=1.24.7';
import { wirePrctx, asUndoBatch } from './properties/context.js?v=1.24.7';
...
import { renderLinkProps, renderMappingControls, LINK_LINE_STYLE_OPTS, applyLinkStroke, applyLinkStrokeWidth, applyLinkLineStyle,
  applyLinkFontColor, applyLinkFontSize, setUserLinkLabel, LINK_MARKER_OPTS, LINK_MARKER_SVGS, buildLinkMarkerDefs, detectLinkMarker, applyLinkMarker } from './properties/link-props.js?v=1.24.7';
export { setLinkEndpoints } from './properties/link-props.js?v=1.24.7';
// Shape type metadata (CLEANUP S2 slice 6) — pure data maps shared by the facade + renderers + convert + autoSizeCell.
import { TYPE_LABELS, DEFAULT_SIZES } from './properties/type-meta.js?v=1.24.7';
...
import { convertToContainer, convertToNode, convertToIcon, convertContainerToIcon, convertFromIcon } from './properties/convert.js?v=1.24.7';
...
import { finishStandardProps, autoSizeCell, buildCellActions } from './properties/render-core.js?v=1.24.7';
export { autoSizeCell, buildCellActions } from './properties/render-core.js?v=1.24.7';
...
export { MATCH_HEIGHT_LABEL, isProcessDiagram, runMatchContainerHeights } from './properties/render-core.js?v=1.24.7';
// Per-family property renderers (CLEANUP S2 slice 8+) — the showProperties() dispatch calls these back.
import { renderSequenceParticipantProps, renderSequenceActorProps, renderSequenceActivationProps, renderSequenceFragmentProps } from './properties/renderers-sequence.js?v=1.24.7';
import { renderOrgPersonProps, renderTaskProps } from './properties/renderers-org.js?v=1.24.7';
import { renderGanttTaskProps, renderGanttMilestoneProps, renderGanttMarkerProps, renderGanttTimelineProps, renderGanttGroupProps } from './properties/renderers-gantt.js?v=1.24.7';
import { renderBpmnEventProps, renderBpmnTaskProps, renderBpmnGatewayProps, renderBpmnSubprocessProps, renderBpmnLoopProps, renderBpmnPoolProps, renderBpmnDataObjectProps, renderFlowShapeProps } from './properties/renderers-process.js?v=1.24.7';
import { renderFlowElementProps } from './properties/renderers-flow.js?v=1.24.7';
import { renderPlaceholderProps, renderSimpleNodeProps, renderContainerProps, renderTextLabelProps, renderPillProps, renderLegendProps, renderTableProps, renderLineProps, renderLinkElementProps, renderNoteProps, renderImageProps, renderZoneProps, renderTaskGroupProps, renderDataObjectProps, renderAnnotationProps } from './properties/renderers-core.js?v=1.24.7';
import { triggerDownload } from './persistence.js?v=1.24.7';
import { confirmModal, showToast, buildModal } from './feedback.js?v=1.24.7';
import { getAllIcons, getIconDataUri } from './icons.js?v=1.24.7';
import { Z_BASE, Z_TIER_SPAN, tierNameForType, updateSimpleNodeLayout, updateDataObjectHeaderLayout, updateContainerHeaderLayout, updateNoteIconLayout, syncMobilePanelHeight, canEmbed, applyMappingLinkStyle, applyRelationshipLinkStyle, syncMappingTypeBadge, syncFrequencyLabel } from './canvas.js?v=1.24.7';
import * as stencilModule from './stencil.js?v=1.24.7';
import { getPalette, addToPalette, removeFromPalette, onPaletteChange, PALETTE_MAX_SLOTS } from './brand-palette.js?v=1.24.7';
import { resizeDataObjectToFit, contrastTextColor, getStencilSvgDataUri, SVG as COMPONENT_SVG, extractLinkDomain } from './components.js?v=1.24.7';
import {
...
} from './clipboard.js?v=1.24.7';
import * as history from './history.js?v=1.24.7';
import { startImageAddFlow } from './image-component.js?v=1.24.7';
import { escHtml, sanitizeFilenamePart, sanitizeCssColor } from './util.js?v=1.24.7';
import { getActiveTabName } from './tabs.js?v=1.24.7';
import { saveSelectionAsTemplate, saveCellAsShape } from './templates.js?v=1.24.7';
import { newFid } from './shapes.js?v=1.24.7';
import { timelineBars, applyGanttGeometry, resequenceGanttOrders, orderToY, ganttRowLayout, ganttTimelineFor, applyGanttGroupGeometry } from './gantt-layout.js?v=1.24.7';
...
const SHAPE_STATE_STYLES = Object.assign(Object.create(null), {
...
const LINK_STATE_STYLES = Object.assign(Object.create(null), {
...
const SHAPE_STATE_TARGET = Object.assign(Object.create(null), { 'df.Legend': 'swatch' });
...
function openTableEditorModal(cell) {
  ...
  const snap = () => ({
    ...
    plainCells: !!cell.get('plainCells'),
    size: { ...cell.size() },
  });
  const applyState = (s) => {
    cell.set({ rows: s.rows.map(r => [...r]), highlightFirstRow: s.highlightFirstRow, highlightFirstCol: s.highlightFirstCol, plainCells: s.plainCells });
  ...
  function rebuild() {
    ...
    const plain = !!cell.get('plainCells');
    ...
    // Until 1.22.0 `plainCells` was converter-only: the facts cards a Flow / data-graph import authors set it
    // (a Salesforce formula's `*` operators are markdown italics otherwise), but a user could neither replicate
    // that on a hand-made table nor toggle it on an imported one - the kind of import-only magic this app
    // deliberately avoids. The view also had no change:plainCells listener, so nothing could repaint it live.
    bar.appendChild(checkRow(plain, 'Plain text cells (no markdown)', (next) => { cell.set('plainCells', next); rebuild(); }));
    modalBody.appendChild(bar);
    const hint = document.createElement('div');
    hint.className = 'df-table-modal__hint';
    // The hint must not promise markdown that a plain-cells table will render literally.
    hint.innerHTML = plain
      ? 'Cells render literally - <code>*</code>, <code>**</code> and <code>`</code> stay as typed. Multiple lines still work.'
      : 'Cells support <b>**bold**</b>, <i>*italic*</i>, ~~strike~~, <code>`code`</code> and multiple lines.';
