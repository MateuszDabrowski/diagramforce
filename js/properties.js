...
import { wrapSelectionWithMarker } from './markdown.js?v=1.21.6';
import { ER_MARKER_D } from './er-markers.js?v=1.21.6';
import { cycleKeyType, keyImpliesRequired, keyTypeLabel, applyKeyType, newField } from './field-model.js?v=1.21.6';
import { COLOR_SCHEMA, recolorCellIcon } from './properties/color-schema.js?v=1.21.6';
import { wirePrctx, asUndoBatch } from './properties/context.js?v=1.21.6';
...
import { renderLinkProps, renderMappingControls, LINK_LINE_STYLE_OPTS, applyLinkStroke, applyLinkStrokeWidth, applyLinkLineStyle,
  applyLinkFontColor, applyLinkFontSize, LINK_MARKER_OPTS, LINK_MARKER_SVGS, buildLinkMarkerDefs, detectLinkMarker, applyLinkMarker } from './properties/link-props.js?v=1.21.6';
export { setLinkEndpoints } from './properties/link-props.js?v=1.21.6';
// Shape type metadata (CLEANUP S2 slice 6) — pure data maps shared by the facade + renderers + convert + autoSizeCell.
import { TYPE_LABELS, DEFAULT_SIZES } from './properties/type-meta.js?v=1.21.6';
...
import { convertToContainer, convertToNode, convertToIcon, convertContainerToIcon, convertFromIcon } from './properties/convert.js?v=1.21.6';
...
import { finishStandardProps, autoSizeCell, buildCellActions } from './properties/render-core.js?v=1.21.6';
export { autoSizeCell, buildCellActions } from './properties/render-core.js?v=1.21.6';
// Per-family property renderers (CLEANUP S2 slice 8+) — the showProperties() dispatch calls these back.
import { renderSequenceParticipantProps, renderSequenceActorProps, renderSequenceActivationProps, renderSequenceFragmentProps } from './properties/renderers-sequence.js?v=1.21.6';
import { renderOrgPersonProps, renderTaskProps } from './properties/renderers-org.js?v=1.21.6';
import { renderGanttTaskProps, renderGanttMilestoneProps, renderGanttMarkerProps, renderGanttTimelineProps, renderGanttGroupProps } from './properties/renderers-gantt.js?v=1.21.6';
import { renderBpmnEventProps, renderBpmnTaskProps, renderBpmnGatewayProps, renderBpmnSubprocessProps, renderBpmnLoopProps, renderBpmnPoolProps, renderBpmnDataObjectProps, renderFlowShapeProps } from './properties/renderers-process.js?v=1.21.6';
import { renderFlowElementProps } from './properties/renderers-flow.js?v=1.21.6';
import { renderPlaceholderProps, renderSimpleNodeProps, renderContainerProps, renderTextLabelProps, renderPillProps, renderLegendProps, renderTableProps, renderLineProps, renderLinkElementProps, renderNoteProps, renderImageProps, renderZoneProps, renderTaskGroupProps, renderDataObjectProps, renderAnnotationProps } from './properties/renderers-core.js?v=1.21.6';
import { triggerDownload } from './persistence.js?v=1.21.6';
import { confirmModal, showToast, buildModal } from './feedback.js?v=1.21.6';
import { getAllIcons, getIconDataUri } from './icons.js?v=1.21.6';
import { Z_BASE, Z_TIER_SPAN, tierNameForType, updateSimpleNodeLayout, updateDataObjectHeaderLayout, updateContainerHeaderLayout, updateNoteIconLayout, syncMobilePanelHeight, canEmbed, applyMappingLinkStyle, applyRelationshipLinkStyle, syncMappingTypeBadge, syncFrequencyLabel } from './canvas.js?v=1.21.6';
import * as stencilModule from './stencil.js?v=1.21.6';
import { getPalette, addToPalette, removeFromPalette, onPaletteChange, PALETTE_MAX_SLOTS } from './brand-palette.js?v=1.21.6';
import { resizeDataObjectToFit, contrastTextColor, getStencilSvgDataUri, SVG as COMPONENT_SVG, extractLinkDomain } from './components.js?v=1.21.6';
import {
...
} from './clipboard.js?v=1.21.6';
import * as history from './history.js?v=1.21.6';
import { startImageAddFlow } from './image-component.js?v=1.21.6';
import { escHtml, sanitizeFilenamePart, sanitizeCssColor } from './util.js?v=1.21.6';
import { getActiveTabName } from './tabs.js?v=1.21.6';
import { saveSelectionAsTemplate, saveCellAsShape } from './templates.js?v=1.21.6';
import { newFid } from './shapes.js?v=1.21.6';
import { timelineBars, applyGanttGeometry, resequenceGanttOrders, orderToY, ganttRowLayout, ganttTimelineFor, applyGanttGroupGeometry } from './gantt-layout.js?v=1.21.6';
