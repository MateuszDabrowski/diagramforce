...
import { convertFlowMetadata } from './flow-convert.js?v=1.23.2';
import { computeFlowLayout } from '../canvas/flow-layout.js?v=1.23.2';
import { pctx } from './context.js?v=1.23.2';
import { parseScalar, foldChild } from './flow-xml.js?v=1.23.2';
