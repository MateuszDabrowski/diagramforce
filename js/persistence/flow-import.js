...
import { convertFlowMetadata } from './flow-convert.js?v=1.24.1';
import { computeFlowLayout } from '../canvas/flow-layout.js?v=1.24.1';
import { pctx } from './context.js?v=1.24.1';
import { parseScalar, foldChild } from './flow-xml.js?v=1.24.1';
