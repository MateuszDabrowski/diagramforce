...
import { decodeShareV1, encodeShareV2, decodeShareV2, encodeGroupLink, decodeGroupLink, slimForShare } from '../share-codec.js?v=1.19.5.8';
...
import { sharePillHtml } from '../storage-ui.js?v=1.19.5.8';
import { pctx } from './context.js?v=1.19.5.8';
import { shareGlyphKind, inviteText } from './drive-sync-logic.js?v=1.19.5.8';
import { isDriveConfigured, isDriveConnected, isSignedIn, shareActiveScoped, shareActiveEditable, activeShareCopies, activeShareStatus, listActiveShareGrants, removeGrant, removeShare, resolveCopyConflict, saveTabsToDrive, publishTabsToSharedDrive, signIn, loadDriveRef, openGroupFromLink, preloadDriveAuth, setLoginHint } from './remote-store.js?v=1.19.5.8';
