...
import { decodeShareV1, encodeShareV2, decodeShareV2, encodeGroupLink, decodeGroupLink, slimForShare } from '../share-codec.js?v=1.21.5';
import { diagramHasImage } from '../image-component.js?v=1.21.5';
import { showToast, showError, buildModal, confirmModal } from '../feedback.js?v=1.21.5';
import { escHtml } from '../util.js?v=1.21.5';
import { sharePillHtml } from '../storage-ui.js?v=1.21.5';
import { pctx } from './context.js?v=1.21.5';
import { shareGlyphKind, inviteText } from './drive-sync-logic.js?v=1.21.5';
import { isDriveConfigured, isDriveConnected, isSignedIn, shareActiveScoped, shareActiveEditable, activeShareCopies, activeShareStatus, listActiveShareGrants, removeGrant, removeShare, resolveCopyConflict, saveTabsToDrive, publishTabsToSharedDrive, signIn, loadDriveRef, openGroupFromLink, preloadDriveAuth, setLoginHint } from './remote-store.js?v=1.21.5';
