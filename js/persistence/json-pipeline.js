...
import { contentSignature, checkVersionWarning } from './versioning.js?v=1.19.5.8';
import { KNOWN_EXT_RE } from './df-format.js?v=1.19.5.8';
import { normalizeDateSuffix } from '../util.js?v=1.19.5.8';
import { escHtml } from '../util.js?v=1.19.5.8';
import { showToast, showError, buildModal } from '../feedback.js?v=1.19.5.8';
import { pctx } from './context.js?v=1.19.5.8';
import { slimForShare } from '../share-codec.js?v=1.19.5.8';
...
import { ALLOWED_CELL_TYPES, MAX_CELL_COUNT } from './diagram-schema.js?v=1.19.5.8';
