...
import { isFocusDimmingEnabled, canEmbed, setDragSelectionBBox } from './canvas.js?v=1.23.0';
import { fieldFocus } from './canvas/focus-state.js?v=1.23.0';
...
import { addResizeHandles, removeResizeHandles, initResizeHandles } from './selection/resize-handles.js?v=1.23.0';
...
import { showContextMenu, startLongPressMenu, cancelLongPressMenu, initContextMenu } from './selection/context-menu.js?v=1.23.0';
export {
  setAutoSizer, setCopyAsPng, setEndpointSetter, setActionProvider, setStyleApi, setCaptureApi, setLaneMatcher,
  copySelectionAsPng,
} from './selection/context-menu.js?v=1.23.0';
