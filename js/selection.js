...
import { isFocusDimmingEnabled, canEmbed, setDragSelectionBBox } from './canvas.js?v=1.23.1';
import { fieldFocus } from './canvas/focus-state.js?v=1.23.1';
...
import { addResizeHandles, removeResizeHandles, initResizeHandles } from './selection/resize-handles.js?v=1.23.1';
...
import { showContextMenu, startLongPressMenu, cancelLongPressMenu, initContextMenu } from './selection/context-menu.js?v=1.23.1';
export {
  setAutoSizer, setCopyAsPng, setEndpointSetter, setActionProvider, setStyleApi, setCaptureApi, setLaneMatcher,
  copySelectionAsPng,
} from './selection/context-menu.js?v=1.23.1';
