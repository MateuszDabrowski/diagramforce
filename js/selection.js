...
import { isFocusDimmingEnabled, canEmbed, setDragSelectionBBox } from './canvas.js?v=1.21.5';
import { fieldFocus } from './canvas/focus-state.js?v=1.21.5';
...
import { addResizeHandles, removeResizeHandles, initResizeHandles } from './selection/resize-handles.js?v=1.21.5';
...
import { showContextMenu, startLongPressMenu, cancelLongPressMenu, initContextMenu } from './selection/context-menu.js?v=1.21.5';
export {
  setAutoSizer, setCopyAsPng, setEndpointSetter, setActionProvider, setStyleApi, setCaptureApi,
  copySelectionAsPng,
} from './selection/context-menu.js?v=1.21.5';
