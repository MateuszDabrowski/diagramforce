...
import { isFocusDimmingEnabled, canEmbed, setDragSelectionBBox } from './canvas.js?v=1.19.1.1';
import { fieldFocus } from './canvas/focus-state.js?v=1.19.1.1';
import { deriveGanttDates, ganttTimelineFor, snapGanttX, growTimelineToFitDates } from './canvas/gantt-layout.js?v=1.19.1.1';
 ...
 */
function showContextMenu(clientX, clientY, model, opts = {}) {
  closeContextMenu();
