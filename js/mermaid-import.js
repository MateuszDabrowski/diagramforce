...
import { createElementFromComponent } from './components.js?v=1.24.6';
import { ER_MARKER_D } from './er-markers.js?v=1.24.6';
import { showError, showToast } from './feedback.js?v=1.24.6';
import { MAX_CELL_COUNT } from './persistence/diagram-schema.js?v=1.24.6';
