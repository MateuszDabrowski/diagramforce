...
import { updateContainerHeaderLayout, updateDataObjectHeaderLayout, updateNoteIconLayout, updateSimpleNodeLayout } from '../canvas.js?v=1.20.1';
import { SVG as COMPONENT_SVG, contrastTextColor, extractLinkDomain, getStencilSvgDataUri, resizeDataObjectToFit } from '../components.js?v=1.20.1';
import { startImageAddFlow } from '../image-component.js?v=1.20.1';
import { recolorCellIcon } from './color-schema.js?v=1.20.1';
import { convertFromIcon, convertToContainer, convertToIcon, convertToNode } from './convert.js?v=1.20.1';
import { renderFieldEditor } from './field-editor.js?v=1.20.1';
import { finishStandardProps } from './render-core.js?v=1.20.1';
import { addAutoSizeBtn, addChipInput, addCloneBtn, addColor, addDeleteBtn, addIconPicker, addNumber, addNumberPair, addOrderButtons, addRaciPicker, addSegmented, addSelect, addText, addTextarea, section, wireMarkdownShortcuts } from './widgets.js?v=1.20.1';
