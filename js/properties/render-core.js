...
import { cctx } from '../canvas/context.js?v=1.23.4';   // leaf context object (no imports of its own) — safe here
import { matchContainerHeights } from '../canvas/auto-layout.js?v=1.23.4';
import { HALO_PARENT_TYPES } from '../canvas/embedding.js?v=1.23.4';   // the exact set fitParentToChildren wraps
import { showToast } from '../feedback.js?v=1.23.4';
import { cloneElementWithConnectors, copy as clipboardCopy, countConnectedConnectors, countConnectors } from '../clipboard.js?v=1.23.4';
import { resizeDataObjectToFit } from '../components.js?v=1.23.4';
import { saveCellAsShape } from '../templates.js?v=1.23.4';
import { COLOR_SCHEMA } from './color-schema.js?v=1.23.4';
import { convertFromIcon, convertToContainer, convertToIcon, convertToNode } from './convert.js?v=1.23.4';
import { DEFAULT_SIZES } from './type-meta.js?v=1.23.4';
import { addApplySizeBtn, addAutoSizeBtn, addCloneBtn, addConvertBtn, addDeleteBtn, addNumber, addNumberPair, addOrderButtons, addRotationField, bringToFront, cloneCellPlain, copyCellStyle, hasStyleClip, pasteCellStyle, section, sendToBack } from './widgets.js?v=1.23.4';
