...
import { cctx } from '../canvas/context.js?v=1.23.7';   // leaf context object (no imports of its own) — safe here
import { matchContainerHeights } from '../canvas/auto-layout.js?v=1.23.7';
import { HALO_PARENT_TYPES } from '../canvas/embedding.js?v=1.23.7';   // the exact set fitParentToChildren wraps
import { showToast } from '../feedback.js?v=1.23.7';
import { cloneElementWithConnectors, copy as clipboardCopy, countConnectedConnectors, countConnectors } from '../clipboard.js?v=1.23.7';
import { resizeDataObjectToFit } from '../components.js?v=1.23.7';
import { saveCellAsShape } from '../templates.js?v=1.23.7';
import { COLOR_SCHEMA } from './color-schema.js?v=1.23.7';
import { convertFromIcon, convertToContainer, convertToIcon, convertToNode } from './convert.js?v=1.23.7';
import { DEFAULT_SIZES } from './type-meta.js?v=1.23.7';
import { addApplySizeBtn, addAutoSizeBtn, addCloneBtn, addConvertBtn, addDeleteBtn, addNumber, addNumberPair, addOrderButtons, addRotationField, bringToFront, cloneCellPlain, copyCellStyle, hasStyleClip, pasteCellStyle, section, sendToBack } from './widgets.js?v=1.23.7';
