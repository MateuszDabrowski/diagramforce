...
import { cloneElementWithConnectors, copy as clipboardCopy, countConnectedConnectors, countConnectors } from '../clipboard.js?v=1.21.3';
import { resizeDataObjectToFit } from '../components.js?v=1.21.3';
import { saveCellAsShape } from '../templates.js?v=1.21.3';
import { COLOR_SCHEMA } from './color-schema.js?v=1.21.3';
...
import { addApplySizeBtn, addAutoSizeBtn, addCloneBtn, addConvertBtn, addDeleteBtn, addNumber, addNumberPair, addOrderButtons, addRotationField, bringToFront, cloneCellPlain, copyCellStyle, hasStyleClip, pasteCellStyle, section, sendToBack } from './widgets.js?v=1.21.3';
