...
import { cloneElementWithConnectors, copy as clipboardCopy, countConnectedConnectors, countConnectors } from '../clipboard.js?v=1.21.6';
...
import { convertFromIcon, convertToContainer, convertToIcon, convertToNode } from './convert.js?v=1.21.6';
import { DEFAULT_SIZES } from './type-meta.js?v=1.21.6';
import { addApplySizeBtn, addAutoSizeBtn, addCloneBtn, addConvertBtn, addDeleteBtn, addNumber, addNumberPair, addOrderButtons, addRotationField, bringToFront, cloneCellPlain, copyCellStyle, hasStyleClip, pasteCellStyle, section, sendToBack } from './widgets.js?v=1.21.6';
