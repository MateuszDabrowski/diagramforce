...
import { applyKeyType, cycleKeyType, keyImpliesRequired, keyTypeLabel, newField } from '../field-model.js?v=1.21.5';
...
import { sanitizeFilenamePart } from '../util.js?v=1.21.5';
