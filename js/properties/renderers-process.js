...
import { contrastTextColor } from '../components.js?v=1.24.7';
import { BPMN_EVENT_STYLE, BPMN_GATEWAY_GLYPH } from '../persistence/diagram-schema.js?v=1.24.7';
import { finishStandardProps } from './render-core.js?v=1.24.7';
import { TYPE_LABELS } from './type-meta.js?v=1.24.7';
import { addColor, addNumber, addSelect, addText, section } from './widgets.js?v=1.24.7';
