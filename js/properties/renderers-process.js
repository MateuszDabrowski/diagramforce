...
import { contrastTextColor } from '../components.js?v=1.19.5.8';
import { finishStandardProps } from './render-core.js?v=1.19.5.8';
import { TYPE_LABELS } from './type-meta.js?v=1.19.5.8';
import { addColor, addNumber, addSelect, addText, section } from './widgets.js?v=1.19.5.8';
