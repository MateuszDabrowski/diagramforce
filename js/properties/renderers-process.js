...
import { contrastTextColor } from '../components.js?v=1.23.6';
import { finishStandardProps } from './render-core.js?v=1.23.6';
import { TYPE_LABELS } from './type-meta.js?v=1.23.6';
import { addColor, addNumber, addSelect, addText, section } from './widgets.js?v=1.23.6';
