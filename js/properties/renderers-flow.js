...
import { addActionBtn, addSelect, addText, addTextarea, addTextWithSuggestions, section } from './widgets.js?v=1.23.5';
import { escHtml } from '../util.js?v=1.23.5';
import { FLOW_ELEMENTS } from '../shapes/flow.js?v=1.23.5';
import { convertFlowPlaceholderTo } from './convert.js?v=1.23.5';
...
import { getActiveTabType } from '../tabs.js?v=1.23.5';
