...
import { addActionBtn, addSelect, addText, addTextarea, addTextWithSuggestions, section } from './widgets.js?v=1.24.6';
import { escHtml } from '../util.js?v=1.24.6';
import { FLOW_ELEMENTS } from '../shapes/flow.js?v=1.24.6';
import { convertFlowPlaceholderTo } from './convert.js?v=1.24.6';
...
import { getActiveTabType } from '../tabs.js?v=1.24.6';
