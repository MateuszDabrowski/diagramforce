...
import { showToast, showError, trapFocus, buildModal } from './feedback.js?v=1.24.7';
import { escHtml, compareSemver, normalizeDateSuffix } from './util.js?v=1.24.7';
import { pctx } from './persistence/context.js?v=1.24.7';
export { assertPctxWired } from './persistence/context.js?v=1.24.7';   // S8 wiring self-check (app.js calls it at end of init)
...
export { exportWEBP, exportPNG, exportSVG, copyCellsAsPng, isGifEncodingInProgress, setGifEncodingListener, exportGIF } from './persistence/image-export.js?v=1.24.7';
export { shareAsURL, copyShareURL, shareGroupToDrive, loadFromURL, hasPendingUrlLoad, copyTabJSON } from './persistence/share-orchestration.js?v=1.24.7';
...
import { isDriveConnected as _isDriveConnected, isDriveConfigured as _isDriveConfigured, signIn as _driveSignIn } from './persistence/remote-store.js?v=1.24.7';
import { contentSignature, classifyVersionDiff, checkVersionWarning } from './persistence/versioning.js?v=1.24.7';
...
export { beginVersionWarningBatch, endVersionWarningBatch } from './persistence/versioning.js?v=1.24.7';
...
import { sanitizeGraphJSON, compactGraphForSave, importJSON, loadJSONText, describePastedJSON, replaceActiveWithJSONText, singleDiagramOf } from './persistence/json-pipeline.js?v=1.24.7';
import { importFlowSource, looksLikeFlowXml, looksLikeFlowJson, stripHttpPreamble } from './persistence/flow-import.js?v=1.24.7';
import { buildDiagram as buildMappingDiagram, fromConnectPayload, parseMappingXmlAll,
  looksLikeMappingJson as _looksLikeMappingJson, looksLikeMappingXml } from './persistence/mapping-convert.js?v=1.24.7';
import { looksLikeDataGraphJson as _looksLikeDataGraphJson, parseDataGraph, buildDataGraphDiagram } from './persistence/datagraph-convert.js?v=1.24.7';
import { looksLikeRoleQueryJson as _looksLikeRoleQueryJson, parseRoles, buildRoleDiagram } from './persistence/role-convert.js?v=1.24.7';
...
import { getNamedSaves, readNamedSave, NAMED_SAVE_PREFIX } from './persistence/storage.js?v=1.24.7';
export {
...
} from './persistence/storage.js?v=1.24.7';
...
export function setReplaceContentHandler(cb) { pctx.onReplaceContent = cb; }
...
export function setActivateTabHandler(cb) { pctx.activateTab = cb; }
...
export function openPasteImport(opts) { pctx.showPasteImport?.(opts); }
