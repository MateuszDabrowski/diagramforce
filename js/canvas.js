...
import { registerSfRouter } from './canvas/router.js?v=1.19.0.49';
...
export { autoLayout, applyDataMappingLayout, analyzeSequenceLayout, applySequenceAutoLayout } from './canvas/auto-layout.js?v=1.19.0.49';
// Phase 4 Slice 4: migration fixups extracted to ./canvas/migration.js
export { migrateLinks, updateSimpleNodeLayout, updateDataObjectHeaderLayout, updateContainerHeaderLayout, updateNoteIconLayout, migrateNodes } from './canvas/migration.js?v=1.19.0.49';
// Phase 4 Slice 5: crossing-bump calculation extracted to ./canvas/crossing-bumps.js
import { initCrossingBumps, getBumpLayer } from './canvas/crossing-bumps.js?v=1.19.0.49';
export { isCrossingBumpsEnabled, setCrossingBumpsEnabled } from './canvas/crossing-bumps.js?v=1.19.0.49';
// Change Review overlay (NBA-1) — transient, non-destructive diff visualisation. cctx-only (no init wiring needed).
export { enterReview, exitReview, isReviewing, getReviewSummary } from './canvas/review-overlay.js?v=1.19.0.49';
// Diagram check (NBA #3, refocused) — find + transiently highlight loose connectors. cctx-only.
export { findLooseConnectors, highlightLooseConnectors, clearLooseHighlight } from './canvas/diagram-check.js?v=1.19.0.49';
...
import { registerViewportControls, getGridColor } from './canvas/viewport.js?v=1.19.0.49';
export { zoomIn, zoomOut, resetZoom, fitContent, toggleGrid, refreshGrid, isGridVisible, getViewport, setViewport } from './canvas/viewport.js?v=1.19.0.49';
...
import { startLineStyleOverlays } from './canvas/line-style.js?v=1.19.0.49';
import { initExternalLabelAutoplace } from './canvas/external-labels.js?v=1.19.0.49';
export { startLineStyleOverlays };
export { initMobileDragHandles, syncMobilePanelHeight } from './canvas/mobile.js?v=1.19.0.49';
...
import { registerSelectionViz } from './canvas/selection-viz.js?v=1.19.0.49';
import { registerBusRouting } from './canvas/bus-routing.js?v=1.19.0.49';
...
import { registerSpacingGuides } from './canvas/spacing-guides.js?v=1.19.0.49';
...
import { canEmbed, findEmbeddingParent, registerEmbedding } from './canvas/embedding.js?v=1.19.0.49';
export { canEmbed };
import { deriveGanttDates, deriveGanttMilestoneDate, deriveGanttMarkerDate, resequenceGanttOrders, ganttTimelineFor, snapGanttX, snapGanttRowCentreY, ganttDropTarget, growTimelineToFitDates } from './canvas/gantt-layout.js?v=1.19.0.49';
export { isAutoSizingEnabled, setAutoSizingEnabled, refitAllParents, findHaloParent, tuckChildInside, showDropGhost, hideDropGhost, setDragSelectionBBox } from './canvas/embedding.js?v=1.19.0.49';
...
export function init() {
  ...
  // Global bus routing (draft, flag-gated OFF): bind plan invalidation to graph changes.
  registerBusRouting(cctx.graph);
