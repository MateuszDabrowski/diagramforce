...
export { assertCctxWired } from './canvas/context.js?v=1.23.1';   // S8 wiring self-check (app.js calls it at end of init)
import { registerSfRouter } from './canvas/router.js?v=1.23.1';
import { Z_BASE, Z_TIER_SPAN, Z_GANTT_DEP, tierNameForType, registerZTiers } from './canvas/z-tiers.js?v=1.23.1';
export { Z_BASE, Z_TIER_SPAN, tierNameForType };   // re-export for properties.js + properties/widgets.js (reorder controls)
import { setIconDataUriFn, refreshIcons, registerIconRefresh } from './canvas/icon-refresh.js?v=1.23.1';
...
import { rerouteAllLinks, buildDefaultLink, registerLinkRuntime } from './canvas/link-runtime.js?v=1.23.1';
...
import { registerLinkClassifier } from './canvas/link-classifier.js?v=1.23.1';
...
export { autoLayout, applyDataMappingLayout, applyFlowLayout, analyzeSequenceLayout, applySequenceAutoLayout, resolveConnectorLabels, matchContainerHeights } from './canvas/auto-layout.js?v=1.23.1';
// Phase 4 Slice 4: migration fixups extracted to ./canvas/migration.js
export { migrateLinks, updateSimpleNodeLayout, updateDataObjectHeaderLayout, updateContainerHeaderLayout, updateNoteIconLayout, migrateNodes, alignFlowAnnotationColumn } from './canvas/migration.js?v=1.23.1';
// Phase 4 Slice 5: crossing-bump calculation extracted to ./canvas/crossing-bumps.js
import { initCrossingBumps, getBumpLayer } from './canvas/crossing-bumps.js?v=1.23.1';
export { isCrossingBumpsEnabled, setCrossingBumpsEnabled } from './canvas/crossing-bumps.js?v=1.23.1';
// Change Review overlay (NBA-1) — transient, non-destructive diff visualisation. cctx-only (no init wiring needed).
export { enterReview, exitReview, isReviewing, getReviewSummary } from './canvas/review-overlay.js?v=1.23.1';
// Diagram check (NBA #3, refocused) — find + transiently highlight loose connectors. cctx-only.
export { findLooseConnectors, highlightLooseConnectors } from './canvas/diagram-check.js?v=1.23.1';
...
export { syncCaptureOverlay } from './canvas/capture-overlay.js?v=1.23.1';
...
import { registerViewportControls, getGridColor } from './canvas/viewport.js?v=1.23.1';
export { zoomIn, zoomOut, resetZoom, fitContent, toggleGrid, refreshGrid, isGridVisible, getViewport, setViewport } from './canvas/viewport.js?v=1.23.1';
...
import { startLineStyleOverlays } from './canvas/line-style.js?v=1.23.1';
import { initExternalLabelAutoplace } from './canvas/external-labels.js?v=1.23.1';
export { initMobileDragHandles, syncMobilePanelHeight } from './canvas/mobile.js?v=1.23.1';
...
import { registerSelectionViz } from './canvas/selection-viz.js?v=1.23.1';
// Hover tooltip for cells that carry one (today: the sf.Link URL). registerCellTooltip(cctx) is called in init().
import { registerCellTooltip } from './canvas/cell-tooltip.js?v=1.23.1';
...
import { registerSpacingGuides } from './canvas/spacing-guides.js?v=1.23.1';
...
import { canEmbed, findEmbeddingParent, registerEmbedding, HALO_PARENT_TYPES } from './canvas/embedding.js?v=1.23.1';
export { canEmbed, HALO_PARENT_TYPES };
export { enclosedCapturableShapes, groupChildrenInto } from './canvas/embedding.js?v=1.23.1';
...
import { registerGanttDrag } from './canvas/gantt-drag.js?v=1.23.1';
...
export { isAutoSizingEnabled, setAutoSizingEnabled, refitAllParents, findHaloParent, tuckChildInside, showDropGhost, hideDropGhost, setDragSelectionBBox } from './canvas/embedding.js?v=1.23.1';
