...
export const DIAGRAM_TYPES = {
  ...
  flow:         { label: 'Flow Diagram',          short: 'Flow' },
...
export function diagramTypeIconMarkup(type) {
  switch (type) {
    ...
    // Flow (Salesforce Flow): a vertical Start(circle) → card → End(circle) spine, matching the uniform-card
    // reality (flows have NO diamonds). Distinct from process (horizontal node+link) and org (1-over-2 hierarchy).
    case 'flow':        return '<circle cx="8" cy="2.4" r="2.2" fill="currentColor"/><line x1="8" y1="4.6" x2="8" y2="6" stroke="currentColor" stroke-width="1"/><rect x="3" y="6" width="10" height="4" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><line x1="8" y1="10" x2="8" y2="11.4" stroke="currentColor" stroke-width="1"/><circle cx="8" cy="13.6" r="2.2" fill="currentColor" opacity="0.7"/>';
