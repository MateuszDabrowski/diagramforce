...
import { DIAGRAM_TYPES } from './diagram-types.js?v=1.23.1';
import { buildModal, confirmModal, showToast } from '../feedback.js?v=1.23.1';
import { bindSplitHeads, driveChipsHtml, groupSelectHtml, refreshSplitTableCounts, setTriStateCheckbox, splitTableHtml, storageRowHtml, tabRowChipsHtml } from '../storage-ui.js?v=1.23.1';
import { countDiagramShapes, escHtml, formatBytes, formatRelativeTime, gaugeLevel, tabInGroup } from '../util.js?v=1.23.1';
