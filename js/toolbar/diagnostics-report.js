...
import { buildModal, showToast } from '../feedback.js?v=1.24.4';
import { formatBytes } from '../util.js?v=1.24.4';
import { recentErrors } from '../diagnostics.js?v=1.24.4';
import { isSessionHalted } from '../tabs/single-window.js?v=1.24.4';
import { getStorageBreakdown, NAMED_SAVE_PREFIX } from '../persistence/storage.js?v=1.24.4';
import { tctx } from './context.js?v=1.24.4';
