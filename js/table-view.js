...
import { escHtml, sanitizeFilenamePart, toMarkdownTable } from './util.js?v=1.19.5.8';
import { getActiveTabName, getActiveTabType } from './tabs.js?v=1.19.5.8';
import { startBatch, endBatch, setLocked, undo } from './history.js?v=1.19.5.8';
import { SF_FIELD_TYPES } from './properties.js?v=1.19.5.8';
import { keyImpliesRequired } from './field-model.js?v=1.19.5.8';
import { buildModal, showToast, showError } from './feedback.js?v=1.19.5.8';
import { buildObjectSchemaCsv } from './data-export.js?v=1.19.5.8';
import { triggerDownload } from './persistence.js?v=1.19.5.8';
import { ganttRowLayout, ganttDependencies, ganttTimelineFor, applyGanttGeometry, resequenceGanttOrders } from './gantt-layout.js?v=1.19.5.8';
import { durationDays, addDaysISO } from './gantt-scale.js?v=1.19.5.8';
...
} from './table-view/builders.js?v=1.19.5.8';
...
import { addGanttTask, deleteGanttBar, reorderGanttBar, openDepEditor, initGanttPlan } from './table-view/gantt-plan.js?v=1.19.5.8';
