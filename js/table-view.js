...
import { escHtml, sanitizeFilenamePart, toMarkdownTable } from './util.js?v=1.19.4.4';
import { getActiveTabName, getActiveTabType } from './tabs.js?v=1.19.4.4';
import { startBatch, endBatch, setLocked, undo } from './history.js?v=1.19.4.4';
import { SF_FIELD_TYPES } from './properties.js?v=1.19.4.4';
import { keyImpliesRequired } from './field-model.js?v=1.19.4.4';
import { buildModal, showToast, showError } from './feedback.js?v=1.19.4.4';
import { buildObjectSchemaCsv } from './data-export.js?v=1.19.4.4';
import { triggerDownload } from './persistence.js?v=1.19.4.4';
import { ganttRowLayout, ganttDependencies, ganttTimelineFor, applyGanttGeometry, resequenceGanttOrders } from './gantt-layout.js?v=1.19.4.4';
import { durationDays, addDaysISO } from './gantt-scale.js?v=1.19.4.4';
...
} from './table-view/builders.js?v=1.19.4.4';
...
import { addGanttTask, deleteGanttBar, reorderGanttBar, openDepEditor, initGanttPlan } from './table-view/gantt-plan.js?v=1.19.4.4';
