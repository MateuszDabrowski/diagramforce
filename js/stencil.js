...
import { COMPONENT_CATEGORIES, BPMN_CATEGORIES, DATAMODEL_CATEGORIES, DATAMAPPING_CATEGORIES, GANTT_CATEGORIES, ORG_CATEGORIES, SEQUENCE_CATEGORIES, FLOW_CATEGORIES, createElementFromComponent, createGanttBarsFor } from './components.js?v=1.21.4';
import { applyGanttGeometry, deriveGanttMilestoneDate, deriveGanttMarkerDate, ganttTimelineFor, deriveGanttDates, backfillGanttOrders, layoutTimelineTasks, ganttDropTarget, ganttGroupInsertOrder, ganttGroupInsertSlotY, snapGanttRowCentreY, recolorGroupTasks } from './gantt-layout.js?v=1.21.4';
import { getAllIcons, getCategories } from './icons.js?v=1.21.4';
import { updateSimpleNodeLayout, updateContainerHeaderLayout, snapActivationToLifeline, canEmbed, findHaloParent, tuckChildInside, showDropGhost, hideDropGhost, clearGanttDateChip, showGanttGroupInsertBar } from './canvas.js?v=1.21.4';
import { startImageAddFlow } from './image-component.js?v=1.21.4';
import * as history from './history.js?v=1.21.4';
import { getTemplates, deleteTemplate, renderTemplateThumbnail, instantiateTemplate, insertTemplateCells, onTemplatesChange } from './templates.js?v=1.21.4';
import { getOfficialTemplates, loadOfficialTemplate, renderOfficialThumbnail } from './official-templates.js?v=1.21.4';
import { getOfficialShapePacks, loadOfficialShapePack } from './official-shapes.js?v=1.21.4';
import { SVG } from './components/stencil-kit.js?v=1.21.4';
import { confirmModal } from './feedback.js?v=1.21.4';
import { escHtml } from './util.js?v=1.21.4';
import { DIAGRAM_TYPES } from './tabs.js?v=1.21.4'; // reader-friendly workspace labels (no cycle: tabs ⊄ stencil)
