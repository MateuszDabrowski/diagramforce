...
import { GANTT_SUMMARY_GROUP_H, GANTT_SUMMARY_MARKER_H, applyGanttGeometry, applyGanttGroupGeometry, applyGanttMarkerGeometry, applyGanttMilestoneGeometry, dateToLocalX, ganttGroupSummary, ganttRowLayout, ganttSummaryLaneH, ganttTimelineFor, layoutTimelineTasks, recolorGroupTasks } from '../gantt-layout.js?v=1.20.0.63';
