...
import { sctx } from './context.js?v=1.22.3';
import { ensureFieldFids, fieldHasLink, getVisibleDataObjectFields } from './fields.js?v=1.22.3';
import { portGroups } from './ports.js?v=1.22.3';
