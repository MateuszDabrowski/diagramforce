...
import { sctx } from './context.js?v=1.23.4';
import { ensureFieldFids, fieldHasLink, getVisibleDataObjectFields } from './fields.js?v=1.23.4';
import { portGroups } from './ports.js?v=1.23.4';
