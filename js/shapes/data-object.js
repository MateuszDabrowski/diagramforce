...
import { sctx } from './context.js?v=1.23.2';
import { ensureFieldFids, fieldHasLink, getVisibleDataObjectFields } from './fields.js?v=1.23.2';
import { portGroups } from './ports.js?v=1.23.2';
