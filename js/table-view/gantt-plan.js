...
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.23.1';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.23.1';
import { buildModal } from '../feedback.js?v=1.23.1';
