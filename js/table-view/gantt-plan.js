...
import { startBatch, endBatch } from '../history.js?v=1.21.7';
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.21.7';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.21.7';
