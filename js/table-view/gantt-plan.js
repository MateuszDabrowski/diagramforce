...
import { startBatch, endBatch } from '../history.js?v=1.22.3';
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.22.3';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.22.3';
