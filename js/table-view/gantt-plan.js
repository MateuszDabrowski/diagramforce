...
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.24.4';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.24.4';
