...
import { startBatch, endBatch } from '../history.js?v=1.19.4.4';
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.19.4.4';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.19.4.4';
import { buildModal } from '../feedback.js?v=1.19.4.4';
