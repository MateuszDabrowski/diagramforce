...
import { startBatch, endBatch } from '../history.js?v=1.19.2.99';
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.19.2.99';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.19.2.99';
