...
import { startBatch, endBatch } from '../history.js?v=1.22.0';
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.22.0';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.22.0';
