...
import { ganttTimelineFor, timelineBars, resequenceGanttOrders, layoutTimelineTasks, applyGanttGeometry, orderToY } from '../gantt-layout.js?v=1.23.3';
import { applyGanttDepLinkStyle } from '../canvas.js?v=1.23.3';
import { buildModal } from '../feedback.js?v=1.23.3';
