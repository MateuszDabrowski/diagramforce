...
export const TEMPLATE_CATEGORIES = [
  ...
  // ── Salesforce Products ────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('Service',      null, { bg: '#8A033E', stencilSvg: '<path d="M10 16L4.5 10.5a3.5 3.5 0 1 1 5-5l.5.5.5-.5a3.5 3.5 0 1 1 5 5Z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>' }),
      ...
      node('Commerce',     null, { bg: '#396547', stencilSvg: '<path d="M3 3h2l2.5 8.5h7.5L17.5 5H7" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round" stroke-linecap="round"/><circle cx="8" cy="15" r="1.2" fill="currentColor" stroke="none"/><circle cx="14" cy="15" r="1.2" fill="currentColor" stroke="none"/>' }),
      ...
      node('Experience',   null, { bg: '#032D60', stencilSvg: '<circle cx="10" cy="6" r="3" fill="none" stroke="currentColor" stroke-width="1.3"/><path d="M4 17.5v-2c0-2.8 2.7-5 6-5s6 2.2 6 5v2" fill="none" stroke="currentColor" stroke-width="1.3"/>' }),
      node('Field Service', null, { bg: '#8A033E', stencilSvg: '<path d="M10 18s-5.5-6-5.5-9.5a5.5 5.5 0 0 1 11 0c0 3.5-5.5 9.5-5.5 9.5z" fill="none" stroke="currentColor" stroke-width="1.3"/><circle cx="10" cy="8.5" r="2" fill="currentColor" stroke="none"/>' }),
      ...
      node('Platform',     null, { bg: '#200647', stencilSvg: '<path d="M11.5 2H7L4 10h4l-2 8 9-10h-5z" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"/>' }),
      ...
      node('Informatica',  null,                   { bg: '#FF4D00', stencilSvg: '<g transform="translate(0.5,0.5) scale(0.297)" fill="currentColor"><g transform="matrix(0.838,0,0,0.827,0,0)"><polygon points="34.29,45.02 57.26,58.04 58.11,48.14 51.74,41.26 42.33,39.68"/><polygon points="38.17,0 57.26,58.04 76.34,38.69"/><polygon points="35.1,30.74 34.3,45.02 63.63,38.69"/><polygon points="20.38,59.35 24.18,54.2 23.49,48.01 14.14,41.86 0,38.69"/><polygon points="0,38.69 23.49,48.01 36.11,2.1"/><polygon points="23.49,48.01 20.38,59.35 38.17,77.39 54.89,60.44"/></g></g>' }),
  ...
  // ── Industries ─────────────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('Energy & Utilities',   null,               { bg: '#F39C12', stencilSvg: '<path d="M11 3H8L5 10h3.5L7 17l8-9h-4.5z" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"/>' }),
  ...
  // ── External Systems ───────────────────────────────────────────────
  {
    ...
    templates: [
      ...
      node('SAP',           'client', { bg: '#0FAAFF', stencilSvg: '<text x="10" y="13" text-anchor="middle" font-size="8" font-weight="bold" fill="currentColor" stroke="none" font-family="system-ui">SAP</text>' }),
      node('Oracle',        'client', { bg: '#F80000', stencilSvg: '<rect x="3" y="6.5" width="14" height="7" rx="3.5" fill="none" stroke="currentColor" stroke-width="2.2"/>' }),
      node('Databricks',    'client', { bg: '#FF3621', stencilSvg: '<path d="M10 3L16 7L10 11L4 7Z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M4 10L10 14L16 10" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M4 13L10 17L16 13" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/>' }),
    ],
  },
  // ── Integrations & APIs ────────────────────────────────────────────
  {
