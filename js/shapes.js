...
import { sctx } from './shapes/context.js?v=1.23.6';
import { registerCore } from './shapes/core.js?v=1.23.6';
import { registerBpmnFlow } from './shapes/bpmn-flow.js?v=1.23.6';
import { registerDataObject } from './shapes/data-object.js?v=1.23.6';
import { registerGantt } from './shapes/gantt.js?v=1.23.6';
import { registerOrg } from './shapes/org.js?v=1.23.6';
import { registerTaskSequence } from './shapes/task-sequence.js?v=1.23.6';
import { registerFlow } from './shapes/flow.js?v=1.23.6';
...
export { newFid, ensureFieldFids, getVisibleDataObjectFields } from './shapes/fields.js?v=1.23.6';
