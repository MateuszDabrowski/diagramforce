...
import { sctx } from './shapes/context.js?v=1.21.3';
import { registerCore } from './shapes/core.js?v=1.21.3';
import { registerBpmnFlow } from './shapes/bpmn-flow.js?v=1.21.3';
import { registerDataObject } from './shapes/data-object.js?v=1.21.3';
import { registerGantt } from './shapes/gantt.js?v=1.21.3';
import { registerOrg } from './shapes/org.js?v=1.21.3';
import { registerTaskSequence } from './shapes/task-sequence.js?v=1.21.3';
import { registerFlow } from './shapes/flow.js?v=1.21.3';
...
export { newFid, ensureFieldFids, getVisibleDataObjectFields } from './shapes/fields.js?v=1.21.3';
