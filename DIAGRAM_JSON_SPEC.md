...
>
> **Spec snapshot: v1.23.7** — matches the app's current `appVersion`; set `"appVersion": "1.23.7"` in generated files.
>
...
| `appVersion` | string | Yes | Semver string, currently `"1.23.7"` |
...
>
> ```json
> { "schema": "diagramforce-export", "version": 1, "appVersion": "1.23.7", "exportedAt": 1712700000000,
>   "diagrams": [ { "name": "...", "diagramType": "architecture", "graph": { "cells": [] }, "viewport": null, "appVersion": "1.23.7" } ],
...
>   "diagrams": [ { "name": "...", "diagramType": "architecture", "group": "Project A", "graph": { "cells": [] }, "viewport": null, "appVersion": "1.23.7" } ] }
> ```
>
...
```json
{
  "version": 1, "appVersion": "1.23.7", "title": "Contact → Individual Mapping", "diagramType": "datamapping",
  "graph": { "cells": [
